...
class WebChrome(Chrome):
    ...
    def appearence_element(self, func, text, timeout=3, interval=0.5):
        """
        Loop to find the target web element by func.
    ...
    @logwrap
    def appearence_xpath(self, xpath):
        """
        ...
        Returns:
            Web element of current page.
        """
        web_element = self.appearence_element(super(WebChrome, self).find_element_by_xpath, xpath)
        return web_element
